...
export function CommunityPreview() {
  ...
  return (
    <AsyncBoundary
      isLoading={isLoading}
      error={error || (data ? null : 'Failed to fetch community standings.')}
    >
      {data && (
            ...
            <div className="flex flex-col items-center justify-center space-y-4 p-6 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="max-w-[280px] text-[10px] leading-relaxed text-muted-foreground">
                  Compare your Carbon Score with the EcoGuide community. Ranks are entirely
                  anonymous by default; only display names are shown.
                </p>
              </div>
              <button
                type="button"
